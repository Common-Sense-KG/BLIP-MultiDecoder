...
from region_model.model.box_describer import BoxDescriber
from region_model.model.roi_heads import DenseCapRoIHeads
...
class DenseCapModel(GeneralizedRCNN):
    ...
    def __init__(self, backbone, return_features = False,
                 ...
                 rpn_pre_nms_top_n_train=2000, rpn_pre_nms_top_n_test=15,#预测时生成个数
                 rpn_post_nms_top_n_train=2000, rpn_post_nms_top_n_test=1000,
                 rpn_nms_thresh=0.7,
                #  rpn_fg_iou_thresh=0.7, rpn_bg_iou_thresh=0.3, essential threshold
                 rpn_fg_iou_thresh=0.7, rpn_bg_iou_thresh=0.5, 
                 rpn_batch_size_per_image=256, rpn_positive_fraction=0.5,
                 # Box parameters
                 box_roi_pool=None, box_head=None, box_predictor=None,
                 box_score_thresh=0.05, box_nms_thresh=0.5, box_detections_per_img=100,
                 box_fg_iou_thresh=0.7, box_bg_iou_thresh=0.7, #set same threshold for matching
    ...
    def forward(self, images, targets=None):
        ...
        return losses, detections, images.image_sizes
